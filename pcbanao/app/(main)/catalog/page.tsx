...
const MOCK_PRODUCTS: IPart[] = [
  { _id: "m1",  name: "Ryzen 9 7950X",                brand: "AMD",     category: "cpu",         price: 699,  stock: 14, images: [], wattage: 170, specs: { Cores: 16, Threads: 32, "Base Clock": "4.5 GHz", "Boost Clock": "5.7 GHz", Socket: "AM5", TDP: "170W" } },
  { _id: "m2",  name: "Core i9-13900K",               brand: "Intel",   category: "cpu",         price: 589,  stock: 9,  images: [], wattage: 125, specs: { Cores: 24, Threads: 32, "Base Clock": "3.0 GHz", "Boost Clock": "5.8 GHz", Socket: "LGA1700", TDP: "125W" } },
  { _id: "m3",  name: "Ryzen 5 7600X",                brand: "AMD",     category: "cpu",         price: 249,  stock: 22, images: [], wattage: 105, specs: { Cores: 6, Threads: 12, "Base Clock": "4.7 GHz", "Boost Clock": "5.3 GHz", Socket: "AM5", TDP: "105W" } },
  { _id: "m4",  name: "GeForce RTX 4090",              brand: "NVIDIA",  category: "gpu",         price: 1599, stock: 4,  images: [], wattage: 450, specs: { VRAM: "24 GB GDDR6X", "Core Clock": "2230 MHz", "Boost Clock": "2520 MHz", TDP: "450W", Interface: "PCIe 4.0 x16" } },
  { _id: "m5",  name: "Radeon RX 7900 XTX",           brand: "AMD",     category: "gpu",         price: 999,  stock: 7,  images: [], wattage: 355, specs: { VRAM: "24 GB GDDR6", "Core Clock": "1900 MHz", "Boost Clock": "2500 MHz", TDP: "355W", Interface: "PCIe 4.0 x16" } },
  { _id: "m6",  name: "GeForce RTX 4070 Ti",           brand: "NVIDIA",  category: "gpu",         price: 799,  stock: 11, images: [], wattage: 285, specs: { VRAM: "12 GB GDDR6X", "Core Clock": "2310 MHz", "Boost Clock": "2610 MHz", TDP: "285W", Interface: "PCIe 4.0 x16" } },
  { _id: "m7",  name: "ROG Crosshair X670E Hero",      brand: "ASUS",    category: "motherboard", price: 629,  stock: 6,  images: [], specs: { Socket: "AM5", Form: "ATX", Chipset: "X670E", "Mem Slots": 4, "Max Mem": "128 GB", "M.2 Slots": 5 } },
  { _id: "m8",  name: "MPG Z790 Carbon WiFi",          brand: "MSI",     category: "motherboard", price: 469,  stock: 8,  images: [], specs: { Socket: "LGA1700", Form: "ATX", Chipset: "Z790", "Mem Slots": 4, "Max Mem": "192 GB", "M.2 Slots": 4 } },
  { _id: "m9",  name: "Trident Z5 RGB 64 GB DDR5-6000",brand: "G.Skill", category: "ram",         price: 219,  stock: 18, images: [], specs: { Capacity: "64 GB", Type: "DDR5", Speed: "6000 MHz", CAS: "CL30", Kit: "2×32 GB" } },
  { _id: "m10", name: "Vengeance DDR5-6200 32 GB",     brand: "Corsair", category: "ram",         price: 129,  stock: 31, images: [], specs: { Capacity: "32 GB", Type: "DDR5", Speed: "6200 MHz", CAS: "CL36", Kit: "2×16 GB" } },
  { _id: "m11", name: "990 Pro 2 TB NVMe SSD",         brand: "Samsung", category: "storage",     price: 179,  stock: 25, images: [], specs: { Capacity: "2 TB", Interface: "PCIe 4.0 NVMe", Read: "7450 MB/s", Write: "6900 MB/s", Form: "M.2 2280" } },
  { _id: "m12", name: "FireCuda 530 4 TB NVMe",        brand: "Seagate", category: "storage",     price: 329,  stock: 12, images: [], specs: { Capacity: "4 TB", Interface: "PCIe 4.0 NVMe", Read: "7300 MB/s", Write: "6900 MB/s", Form: "M.2 2280" } },
  { _id: "m13", name: "HX1200 Platinum 1200W",         brand: "Corsair", category: "psu",         price: 229,  stock: 9,  images: [], wattage: 1200, specs: { Wattage: "1200W", Efficiency: "80+ Platinum", Modular: "Fully Modular", Form: "ATX" } },
  { _id: "m14", name: "Lian Li O11D EVO RGB",          brand: "Lian Li", category: "case",        price: 179,  stock: 5,  images: [], specs: { Form: "Mid Tower", "MB Support": "E-ATX/ATX/mATX/ITX", "Max Cooler": "167 mm", "Max GPU": "420 mm" } },
  { _id: "m15", name: "Kraken Elite 360 AIO",          brand: "NZXT",    category: "cooler",      price: 269,  stock: 0,  images: [], wattage: 25,  specs: { Type: "Liquid AIO", Radiator: "360 mm", Fans: "3×120 mm", Sockets: "AM5/AM4/LGA1700", "Max TDP": "400W+" } },
];
...
export default function CatalogPage() {
  ...
  const filtered = useMemo(() => {
    let list = [...products];
    if (search) { const q = search.toLowerCase(); list = list.filter((p) => p.name.toLowerCase().includes(q) || p.brand.toLowerCase().includes(q) || p.category.toLowerCase().includes(q)); }
    ...
    return list;
  }, [products, search, selectedCategory, minPrice, maxPrice, inStockOnly, sortKey]);
