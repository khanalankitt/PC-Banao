      ...
      >
        ...
        <div
          style={{
            ...
            padding: '4px 10px',
            borderRadius: '20px',
            background: compatible ? 'rgba(0,255,136,0.15)' : 'rgba(239,68,68,0.15)',
        ...
        <div style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
          <button
            style={{
              ...
              padding: '10px 0',
              borderRadius: '9px',
              background: hovered ? 'linear-gradient(135deg, rgba(0,212,255,0.2), rgba(0,212,255,0.1))' : 'rgba(0,212,255,0.1)',
...
function SignInPrompt() {
  return (
    ...
    >
      ...
      >
        Create an account to save, share, and clone your custom PC configurations. It&apos;s free.
      </p>
      <button
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Explore builds from the PC Banao community. Clone any config and make it your own in seconds.
          </p>
          ...
          >
            {[
              { value: totalBuilds.toString(), label: 'Total Builds', color: 'var(--cyan)' },
              { value: `${compatPct}%`, label: 'Compatible', color: 'var(--neon-green)' },
              { value: `$${avgPrice.toLocaleString()}`, label: 'Avg Price', color: '#a78bfa' },
            ].map(({ value, label, color }, i) => (
              <div
                key={label}
                style={{
                  padding: '16px 28px',
                  borderRight: i < 2 ? '1px solid var(--border-divider)' : 'none',
                  textAlign: 'center',
                }}
              >
                <div style={{ fontSize: '24px', fontWeight: 800, color, letterSpacing: '-0.02em' }}>
                  {value}
                </div>
                <div
                  style={{
      ...
      >
        ...
        {activeTab === 'mine' && status !== 'loading' && !session ? (
          ...
          >
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 700, color: 'var(--text-primary)', margin: '0 0 10px' }}>
              No builds yet
            </h3>
          ...
          <>
            ...
            >
              <div>
                ...
                >
                  {activeTab === 'community' ? 'Featured Builds' : 'Your Configurations'}
                </h2>
                <p style={{ margin: '4px 0 0', fontSize: '13px', color: 'var(--text-muted)' }}>
                  {displayedBuilds.length} build{displayedBuilds.length !== 1 ? 's' : ''} shown
                </p>
              </div>
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                >
                  <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--neon-green)', boxShadow: '0 0 6px var(--neon-green)', display: 'block' }} />
